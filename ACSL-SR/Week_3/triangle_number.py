...
def triangle_number(n):
    ...
    The nth triangular number is the number of dots composing a triangle with n dots on the tier,
    ...
    #remember that pseudocode is to break down into simplest parts
    #base case is when it's as simple as possible
    #Pseudocode of recursion:
    #configure the base case first
    #btw "base case" = refers to conditional
    #"what condition do I wanna quit?"
    #THEN recursive case (basically what you want to do until base case) will come naturally
    #recursive case refers to the action inside "else"
    #te
    
#print("3", triangle_number(3))
